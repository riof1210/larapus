                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="" value="{{ $book->author->name }}" class="form-control" readonly>
                        </div>
                        <div class="form-group">
                            <label for="">Jumlah Buku</label>
                            <input type="text" name="amount" value="{{ $book->amount }}" class="form-control" readonly>
                        </div>
                        <div class="form-group">
                            <label for="">Cover Buku</label>
                            <br>
                            <img src="{{ $book->image() }}" style="width: 350px; height: 350px; padding:10px" alt="">
                        </div>
                        <div class="form-group">
